...
class PSMNet(nn.Module):
    ...
    def forward(self, left, right):
        ...
        #matching
        cost = Variable(torch.FloatTensor(refimg_fea.size()[0], refimg_fea.size()[1]*2, self.max_disp//4,  refimg_fea.size()[2],  refimg_fea.size()[3]).zero_()).cuda()
